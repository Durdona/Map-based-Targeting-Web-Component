...
const geojsonTargetingResults = {
	...
	results: {
		geojson: {
			bbox: [ -122.58098602294922, 45.39893211771299, -122.31044769287111, 45.544110148533896 ],
			features: [
				{
					geometry: {
						coordinates: [
		...
		message: " Sorry, couldn't process your request. Server Error. Please try again"
	}
};
// setup mocked request/responses

// Radial Search Tab NO PROPS
const MEMBER_TARGETING_URL_SUCCESS_RADIAL_NO_PROPS = "https://member_targeting_service/success/radial/no/props";
mock.onPost(MEMBER_TARGETING_URL_SUCCESS_RADIAL_NO_PROPS).reply(200, radialTargetingResults);

//  GeoJSON Search Tab NO PROP
const MEMBER_TARGETING_URL_SUCCESS_GEOJSON_NO_PROPS = "https://member_targeting_service/success/geojson/no/props";
mock.onPost(MEMBER_TARGETING_URL_SUCCESS_GEOJSON_NO_PROPS).reply(200, geojsonTargetingResults);

//  GeoJSON Search Server ERROR
const MEMBER_TARGETING_URL_SUCCESS_GEOJSON_ERROR = "https://member_targeting_service/success/geojson/server/error";
mock.onPost(MEMBER_TARGETING_URL_SUCCESS_GEOJSON_ERROR).reply(200, geojsonTargetingResults);

// Radial Search Tab PROPS
const MEMBER_TARGETING_URL_SUCCESS_RADIAL_PROPS = "https://member_targeting_service/success/radial/props";
mock.onPost(MEMBER_TARGETING_URL_SUCCESS_RADIAL_PROPS).reply(200, radialTargetingResults);

//  GeoJSON Search Tab PROPS
const MEMBER_TARGETING_URL_SUCCESS_GEOJSON_PROPS = "https://member_targeting_service/success/geojson/props";
mock.onPost(MEMBER_TARGETING_URL_SUCCESS_GEOJSON_PROPS).reply(200, geojsonTargetingResults);
...
storiesOf("TargetingV2/TargetingV2", module).add("Radial Search Showing Previously Saved Data", () => ({
	name: "RadialSearchTab",
	components: {
		TargetingV2
	},
...
storiesOf("TargetingV2/TargetingV2", module).add("GeoJSON Search Showing Previously Saved Data", () => ({
	name: "GeoJSONSearchTab",
	components: {
		TargetingV2
	},
